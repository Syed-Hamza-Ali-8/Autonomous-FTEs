#!/usr/bin/env python3
"""
Setup Twitter/X session for Playwright automation.

This script opens Twitter in a browser and saves your login session
...
def setup_twitter_session():
    """Setup Twitter session for automation."""
    print("=" * 70)
    ...
    # Session path
    session_path = VAULT_PATH / "gold" / "config" / "twitter_session"
    session_path.parent.mkdir(parents=True, exist_ok=True)

    print(f"📁 Session will be saved to: {session_path}")
    print()

    input("Press Enter to open Twitter in browser...")
    print()
    ...
    with sync_playwright() as p:
        ...
        print("  3. Wait until you see your Twitter feed")
        ...
        if "login" in current_url.lower() or current_url == "https://twitter.com/":
        ...
        print("=" * 70)
        print("✅ TWITTER SESSION SAVED!")
        print("=" * 70)
        print()
        print(f"Session saved to: {session_path}")
        print()
        print("You can now use the Twitter poster:")
        print("  python gold/src/actions/twitter_poster_playwright.py")
        print()
